<template>
  <div class="container">
    ...
    <modal-component ref="uniPickerModal">
      ...
      <modal-footer-components>
        <div class="btn-wrapper" style="margin-top:-30rpx; margin-bottom:20rpx;">
          <buttonComponent btn_src="/static/images/res/moveInLabRequest2/b1.png" :btn_fn="uniPickerModalBtnFn" btn_label="确定" font_size="font-size:30rpx"></buttonComponent>
        </div>
      </modal-footer-components>
    </modal-component>
    ...
    <modal-component ref="schoolPickerModal">
      ...
      <modal-footer-components>
        <div class="btn-wrapper" style="margin-top:-30rpx; margin-bottom:20rpx;">
          <buttonComponent btn_src="/static/images/res/moveInLabRequest2/b1.png" :btn_fn="schoolPickerModalBtnFn" btn_label="确定" font_size="font-size:30rpx"></buttonComponent>
        </div>
      </modal-footer-components>
    </modal-component>
  </div>
