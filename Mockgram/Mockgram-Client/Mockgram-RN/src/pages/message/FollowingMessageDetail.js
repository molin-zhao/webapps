        ...
        return (
            <DynamicContentList
                request={{
                    ...
                    body: {
                        limit: config.messageReturnLimit,
                ...
                footerNoMore={
                    <Text style={{ color: 'grey', fontSize: 12 }}>- No more messages -</Text>
                }
            />
        );
    }
...
export default connect(mapStateToProps, null)(FollowingMessageDetail);
