    ...
    renderButton = () => {
        ...
        return (
            <View style={{
                ...
                <Button
                    containerStyle={[{ width: '90%', height: 40 }, profile.followed ? followingStyle : followStyle]}
                    loading={this.state.followActionProcessing}
                    titleStyle={[{ fontSize: 14, color: '#fff', marginRight: 10 }]}
                    iconRight={() => {
                        if (profile.followed) {
                            return (
                                <Ionicon name='md-checkmark' color='#fff' size={18} />
                            );
                        }
                        return null;
                    }}
                    ...
                    onPress={() => {
                        profile.followed ? this.showActionSheet() : this.followAction('Follow')
                    }} />
            </View>
        );
        ...
        return (
            ...
            >
                ...
                <View style={styles.embeddedTabView}>
                    ...
                    >
                        <PostsGridView type='CREATED' userId={userProfile._id} refreshing={this.state.refreshing} dataSource={null} numColumns={3} />
                        <PostsGridView type='LIKED' userId={userProfile._id} refreshing={this.state.refreshing} dataSource={null} numColumns={3} />
                        <PostsGridView type='MENTIONED' userId={userProfile._id} refreshing={this.state.refreshing} dataSource={null} numColumns={3} />
                    </TabView>
                </View>
                <ActionSheet
                    ref={o => this.ActionSheet = o}
                    title='Confirm this action to unfollow user'
                    message={`\nDo you want to unfollow user ${userProfile.username}?\nYou will not receive any updates and messages from this user`}
