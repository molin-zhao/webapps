    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                {this.state.selectedFilter === 0 ? <Image style={styles.mainImage} source={{ uri: image.uri }} /> : <ExpoPixi.FilterImage source={{ uri: image.uri }} resizeMode='cover' style={styles.mainImage} filters={this.applyFilter()} />
                }
                <ScrollView style={styles.filterImages} contentContainerStyle={{ justifyContent: 'space-between', alignItems: 'center', paddingStart: 10, paddingEnd: 10 }} showsHorizontalScrollIndicator={false} horizontal={true}>
                    <TouchableOpacity key={0} onPress={() => {
                        ...
                        <Text>original</Text>
                        <ExpoPixi.FilterImage source={{ uri: image.uri }} resizeMode='cover' style={{ height: window.width / 4, width: window.width / 4 }} />
                    </TouchableOpacity>
                    <TouchableOpacity key={1} onPress={() => {
                        ...
                        style={styles.filterImageCell}>
                        <Text>dot</Text>
                        <ExpoPixi.FilterImage source={{ uri: image.uri }} resizeMode='cover' style={{ height: window.width / 4, width: window.width / 4 }} filters={new filters.DotFilter(0.8)} />
                    </TouchableOpacity>
                    <TouchableOpacity key={2} onPress={() => {
                        ...
                        style={styles.filterImageCell}>
                        <Text>blur</Text>
                        <ExpoPixi.FilterImage source={{ uri: image.uri }} resizeMode='cover' style={{ height: window.width / 4, width: window.width / 4 }} filters={new filters.BlurFilter()} />
                    </TouchableOpacity>
                    <TouchableOpacity key={3} onPress={() => {
                        ...
                        style={styles.filterImageCell}>
                        <Text>noise</Text>
                        <ExpoPixi.FilterImage source={{ uri: image.uri }} resizeMode='cover' style={{ height: window.width / 4, width: window.width / 4 }} filters={new filters.NoiseFilter()} />
                    </TouchableOpacity>
                    <TouchableOpacity key={4} onPress={() => {
                        ...
                        <ExpoPixi.FilterImage source={{ uri: image.uri }} resizeMode='cover' style={{ height: window.width / 4, width: window.width / 4 }} filters={(new filters.ColorMatrixFilter()).brightness(0.6)} />
                    </TouchableOpacity>
                </ScrollView>
            </View>
        );
