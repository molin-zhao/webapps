            ...
            <View style={styles.container}>
                <TouchableOpacity
                    ...
                    <View style={{
                        ...
                        <Text ellipsizeMode='tail' numberOfLines={1}>{dataSource.bio}</Text>
                        <Text style={{ color: 'grey', fontSize: 12 }} ellipsizeMode='tail' numberOfLines={1}>{this.renderRecentMessage(dataSource.recentMessage)}</Text>
                    </View>
                </TouchableOpacity>
                <View style={{
                    flex: 1,
...
export default connect(mapStateToProps, null)(withNavigation(FollowingMessasgeUserListCell))
