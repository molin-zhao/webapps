...
const inputImageTexture2 = resolveAssetSource(require('../../assets/filters/earlyBirdCurves.png'));
const inputImageTexture3 = resolveAssetSource(require('../../assets/filters/earlybirdOverlayMap.png'));
const inputImageTexture4 = resolveAssetSource(require('../../assets/filters/vignetteMap.png'));
const inputImageTexture5 = resolveAssetSource(require('../../assets/filters/earlybirdBlowout.png'));
const inputImageTexture6 = resolveAssetSource(require('../../assets/filters/earlybirdMap.png'));
